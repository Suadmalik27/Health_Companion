...
with col1:
    ...
    st.markdown("""
        ...
        <ul>
            <li><span>💊</span> Take your medications at the right time</li>
            <li><span>🗓️</span> Keep track of your upcoming doctor appointments</li>
            <li><span>📞</span> Access emergency contact numbers when needed</li>
        </ul>
